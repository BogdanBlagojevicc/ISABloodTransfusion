...
public class CenterAdministrator {
    ...
    public CenterAdministrator(String email, String password, String firstName, String lastName,
            String address, String city, String country, String phoneNumber, String jmbg, com.example.isa.model.dto.Gender gender2,
            String profession, String education) {
        this.email = email;
        this.password = password;
        this.firstName = firstName;
